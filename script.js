document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleTitleClick() { titleClickCount++; if (titleClickCount === 1) { titleClickTimer = setTimeout(() => { titleClickCount = 0; }, 500); } else if (titleClickCount === 4) { clearTimeout(titleClickTimer); titleClickCount = 0; aboutModal.classList.remove('hidden'); } }
